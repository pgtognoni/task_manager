...
function HomePage() {
  return (
    <div className='p-4'>
      <section className='section sec-1 p-3'>
      ...
      <section className='section sec-2 p-3'>
        <div className='gray-box'></div>
      ...
      <section className='section sec-3 p-3 mt-3 d-flex justify-content-center align-items-center'>
